...
import { HttpStatusCode } from "../helper/site-helper/enums";
 ...
 */
 ...
 export async function request(uri, method, body) {
   ...
   return await fetch(`https://localhost:44366/api/${uri}`, {
...
const handleResponse =(response)=> {
  switch (response.status) {
      ...
      case HttpStatusCode.Unauthorized: Alert("Yetkisiz Giriş"); break;
      case HttpStatusCode.NotFound:  Alert("SAYFA BULUNAMADİ");  break;
      case HttpStatusCode.BadRequest: Alert("BAD REQUEST"); break;
 }
}
